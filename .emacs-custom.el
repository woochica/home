(custom-set-variables
 ...
 '(erc-nick "nyuhuhuu")
 '(erc-server "im.bitlbee.org")
 '(erc-user-full-name "Török Gábor")
 '(fill-column 79)
 ...
 '(org-default-notes-file "~/slink/slink.org")
 '(org-directory "~/slink")
...
(custom-set-faces
  ...
  ;; Your init file should contain only one such instance.
  ;; If there is more than one, they won't work right.
 '(css-selector ((t (:inherit font-lock-function-name-face :weight bold))))
